...
void HinaPE::ClothEngine::ClothSolver::onInitialize()
{
...
auto HinaPE::ClothEngine::ClothSolver::Builder::build() -> HinaPE::ClothEngine::ClothSolver
{
    return {};
}

auto HinaPE::ClothEngine::ClothSolver::Builder::make_shared() -> HinaPE::ClothEngine::ClothSolverPtr
{
    return {new ClothSolver(), [](ClothSolver *obj)
    {
        delete obj;
    }};
}
