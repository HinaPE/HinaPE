#include "pcisph_akinci_twoway.h"

void HinaPE::PCISPHAkinciTwoWay::init() {
    if (_data == nullptr)
...
void HinaPE::PCISPHAkinciTwoWay::_init_boundary_particles() const {
...
void HinaPE::PCISPHAkinciTwoWay::_init_collider() const
{
    {
...
void HinaPE::PCISPHAkinciTwoWay::update(real dt)
{
    // algorithm line 2~3
...
void HinaPE::PCISPHAkinciTwoWay::_update_fluid_neighbor() const {
...
void HinaPE::PCISPHAkinciTwoWay::_update_boundary_neighbor() const {
    auto &bnl = _data->BoundaryNeighborList;
    const auto fluid_size = _data->fluid_size();
    const auto &x = _data->Fluid.positions;
    const auto boundary_size = _data->boundary_size();
...
void HinaPE::PCISPHAkinciTwoWay::_update_boundary_volume() const
{
...
void HinaPE::PCISPHAkinciTwoWay::_update_density() const
{
...
void HinaPE::PCISPHAkinciTwoWay::_accumulate_non_pressure_force() const
{
...
void HinaPE::PCISPHAkinciTwoWay::_initialize_pressure_and_pressure_force() const {
...
void HinaPE::PCISPHAkinciTwoWay::_prediction_correction_step() {
    int iteration = 0;
...
void HinaPE::PCISPHAkinciTwoWay::_predict_velocity_and_position() const {
    auto &x = _data->Fluid.positions;
    auto &v = _data->Fluid.velocities;
    auto &f = _data->Fluid.non_pressure_forces;
    auto &p_f = _data->Fluid.pressure_forces;
...
void HinaPE::PCISPHAkinciTwoWay::_predict_density() const
{
...
void HinaPE::PCISPHAkinciTwoWay::_update_pressure() {
    auto &p = _data->Fluid.pressures;
    auto &d_p = _data->Fluid.predicted_densities;
    auto &d_e = _data->Fluid.density_errors;
    const auto fluid_size = _data->fluid_size();
...
void HinaPE::PCISPHAkinciTwoWay::_accumulate_pressure_force() {
    auto &x_p = _data->Fluid.predicted_positions;
    auto &p_f = _data->Fluid.pressure_forces;
    auto &p = _data->Fluid.pressures;
    auto &d_e = _data->Fluid.density_errors;
...
auto HinaPE::PCISPHAkinciTwoWay::_compute_delta() const -> real
{
    SpikyKernel spiky(_opt.kernel_radius);
...
void HinaPE::PCISPHAkinciTwoWay::_compute_boundary_forces() const {
...
void HinaPE::PCISPHAkinciTwoWay::INSPECT() {
// Solver Parameters
...
void HinaPE::PCISPHAkinciTwoWay::_solve_rigid_body() const {
...
void HinaPE::PCISPHAkinciTwoWay::_compute_rest_mass_center() const {
    auto &b_v = _data->Boundary.volume;
...
mVector3 HinaPE::PCISPHAkinciTwoWay::_compute_mass_center(size_t i) const {
    real sum_mass = 0.0;
    mVector3 center_of_mass(0.0, 0.0, 0.0);
...
mMatrix3x3 HinaPE::PCISPHAkinciTwoWay::solve_constraints(size_t i) const {
...
auto HinaPE::PCISPHAkinciTwoWay::_compute_outer_product(mVector3 p, mVector3 q) -> mMatrix3x3 {
...
auto HinaPE::PCISPHAkinciTwoWay::Data::fluid_size() const -> size_t {
    return Fluid.positions.size();
}

auto HinaPE::PCISPHAkinciTwoWay::Data::boundary_size() const -> size_t {
    return Boundary.positions.size();
}

void HinaPE::PCISPHAkinciTwoWay::Data::reset() {
...
void HinaPE::PCISPHAkinciTwoWay::Data::add_fluid(const std::vector<mVector3> &positions, const std::vector<mVector3> &velocities) {
...
void HinaPE::PCISPHAkinciTwoWay::Data::add_boundary(const std::vector<mVector3> &positions, const Kasumi::Pose *pose) {
...
void HinaPE::PCISPHAkinciTwoWay::Data::update_boundary() {
