...
{
    return HinaPE::fbs::CreateScalarGridSerialized3(_fbb, type ? _fbb.CreateString(type) : 0, data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}
...
{
    return HinaPE::fbs::CreateVectorGridSerialized3(_fbb, type ? _fbb.CreateString(type) : 0, data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}
...
struct GridSystemData3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<HinaPE::fbs::Size3>(verifier, VT_RESOLUTION) && VerifyField<HinaPE::fbs::Vector3D>(verifier, VT_GRIDSPACING) && VerifyField<HinaPE::fbs::Vector3D>(verifier, VT_ORIGIN) && VerifyField<uint64_t>(verifier, VT_VELOCITYIDX) &&
...
inline flatbuffers::Offset<GridSystemData3> CreateGridSystemData3(flatbuffers::FlatBufferBuilder &_fbb, const HinaPE::fbs::Size3 *resolution = 0, const HinaPE::fbs::Vector3D *gridSpacing = 0, const HinaPE::fbs::Vector3D *origin = 0, uint64_t velocityIdx = 0,
...
inline flatbuffers::Offset<GridSystemData3> CreateGridSystemData3Direct(flatbuffers::FlatBufferBuilder &_fbb, const HinaPE::fbs::Size3 *resolution = 0, const HinaPE::fbs::Vector3D *gridSpacing = 0, const HinaPE::fbs::Vector3D *origin = 0, uint64_t velocityIdx = 0,
...
{
    return HinaPE::fbs::CreateGridSystemData3(_fbb, resolution, gridSpacing, origin, velocityIdx, scalarData ? _fbb.CreateVector<flatbuffers::Offset<ScalarGridSerialized3>>(*scalarData) : 0,
...
inline const HinaPE::fbs::GridSystemData3 *GetGridSystemData3(const void *buf)
{
    return flatbuffers::GetRoot<HinaPE::fbs::GridSystemData3>(buf);
}

inline bool VerifyGridSystemData3Buffer(flatbuffers::Verifier &verifier)
{
    return verifier.VerifyBuffer<HinaPE::fbs::GridSystemData3>(nullptr);
}

inline void FinishGridSystemData3Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<HinaPE::fbs::GridSystemData3> root)
{
    fbb.Finish(root);
}
