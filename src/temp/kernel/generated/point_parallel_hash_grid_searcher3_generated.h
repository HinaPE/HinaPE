...
struct PointParallelHashGridSearcher3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    {
        return VerifyTableStart(verifier) && VerifyField<double>(verifier, VT_GRIDSPACING) && VerifyField<jet::fbs::Size3>(verifier, VT_RESOLUTION) && VerifyOffset(verifier, VT_POINTS) && verifier.Verify(points()) && VerifyOffset(verifier, VT_KEYS) &&
...
CreatePointParallelHashGridSearcher3(flatbuffers::FlatBufferBuilder &_fbb, double gridSpacing = 0.0, const jet::fbs::Size3 *resolution = 0, flatbuffers::Offset<flatbuffers::Vector<const jet::fbs::Vector3D *>> points = 0,
...
inline flatbuffers::Offset<PointParallelHashGridSearcher3>
CreatePointParallelHashGridSearcher3Direct(flatbuffers::FlatBufferBuilder &_fbb, double gridSpacing = 0.0, const jet::fbs::Size3 *resolution = 0, const std::vector<const jet::fbs::Vector3D *> *points = nullptr, const std::vector<uint64_t> *keys = nullptr,
...
{
    return jet::fbs::CreatePointParallelHashGridSearcher3(_fbb, gridSpacing, resolution, points ? _fbb.CreateVector<const jet::fbs::Vector3D *>(*points) : 0, keys ? _fbb.CreateVector<uint64_t>(*keys) : 0,
...
inline void FinishPointParallelHashGridSearcher3Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<jet::fbs::PointParallelHashGridSearcher3> root)
{
    fbb.Finish(root);
}
