...
struct PointParallelHashGridSearcher2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    enum
    {
        VT_GRIDSPACING = 4, VT_RESOLUTION = 6, VT_POINTS = 8, VT_KEYS = 10, VT_STARTINDEXTABLE = 12, VT_ENDINDEXTABLE = 14, VT_SORTEDINDICES = 16
    };
    ...
    {
        return VerifyTableStart(verifier) && VerifyField<double>(verifier, VT_GRIDSPACING) && VerifyField<HinaPE::fbs::Size2>(verifier, VT_RESOLUTION) && VerifyOffset(verifier, VT_POINTS) && verifier.Verify(points()) && VerifyOffset(verifier, VT_KEYS) &&
...
struct PointParallelHashGridSearcher2Builder
{
    ...
    PointParallelHashGridSearcher2Builder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb)
    {
...
CreatePointParallelHashGridSearcher2(flatbuffers::FlatBufferBuilder &_fbb, double gridSpacing = 0.0, const HinaPE::fbs::Size2 *resolution = 0, flatbuffers::Offset<flatbuffers::Vector<const HinaPE::fbs::Vector2D *>> points = 0,
...
inline flatbuffers::Offset<PointParallelHashGridSearcher2>
CreatePointParallelHashGridSearcher2Direct(flatbuffers::FlatBufferBuilder &_fbb, double gridSpacing = 0.0, const HinaPE::fbs::Size2 *resolution = 0, const std::vector<const HinaPE::fbs::Vector2D *> *points = nullptr, const std::vector<uint64_t> *keys = nullptr,
...
{
    return HinaPE::fbs::CreatePointParallelHashGridSearcher2(_fbb, gridSpacing, resolution, points ? _fbb.CreateVector<const HinaPE::fbs::Vector2D *>(*points) : 0, keys ? _fbb.CreateVector<uint64_t>(*keys) : 0,
...
inline const HinaPE::fbs::PointParallelHashGridSearcher2 *GetPointParallelHashGridSearcher2(const void *buf)
{
    return flatbuffers::GetRoot<HinaPE::fbs::PointParallelHashGridSearcher2>(buf);
}

inline bool VerifyPointParallelHashGridSearcher2Buffer(flatbuffers::Verifier &verifier)
{
    return verifier.VerifyBuffer<HinaPE::fbs::PointParallelHashGridSearcher2>(nullptr);
}

inline void FinishPointParallelHashGridSearcher2Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<HinaPE::fbs::PointParallelHashGridSearcher2> root)
{
    fbb.Finish(root);
}
