...
struct SphSystemData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    const HinaPE::fbs::ParticleSystemData2 *base() const
    {
        return GetPointer<const HinaPE::fbs::ParticleSystemData2 *>(VT_BASE);
    }
...
struct SphSystemData2Builder
{
    ...
    void add_base(flatbuffers::Offset<HinaPE::fbs::ParticleSystemData2> base)
    {
...
CreateSphSystemData2(flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<HinaPE::fbs::ParticleSystemData2> base = 0, double targetDensity = 0.0, double targetSpacing = 0.0, double kernelRadiusOverTargetSpacing = 0.0, double kernelRadius = 0.0,
...
inline const HinaPE::fbs::SphSystemData2 *GetSphSystemData2(const void *buf)
{
    return flatbuffers::GetRoot<HinaPE::fbs::SphSystemData2>(buf);
}

inline bool VerifySphSystemData2Buffer(flatbuffers::Verifier &verifier)
{
    return verifier.VerifyBuffer<HinaPE::fbs::SphSystemData2>(nullptr);
}

inline void FinishSphSystemData2Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<HinaPE::fbs::SphSystemData2> root)
{
    fbb.Finish(root);
}
