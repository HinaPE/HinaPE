...
template<typename T>
constexpr Vector3<T>::Vector3() : _v(0, 0, 0) {}
template<typename T>
constexpr Vector3<T>::Vector3(T s) : _v(s, s, s) {}
template<typename T>
constexpr Vector3<T>::Vector3(T x_, T y_, T z_) : _v(x_, y_, z_) {}
template<typename T>
constexpr Vector3<T>::Vector3(const Vector3 &v) : _v(v._v) {}
template<typename T>
constexpr Vector3<T>::Vector3(Vector3 &&v) noexcept : _v(std::move(v._v)) {}
template<typename T>
...
template<typename T>
auto Vector3<T>::z() -> T & { return this->_v[2]; }
template<typename T>
auto Vector3<T>::x() const -> const T & { return this->_v[0]; }
template<typename T>
auto Vector3<T>::y() const -> const T & { return this->_v[1]; }
template<typename T>
auto Vector3<T>::z() const -> const T & { return this->_v[2]; }
template<typename T>
