#ifndef HINAPE_INTERSECTION_QUERY_ENGINE2_H_
#define HINAPE_INTERSECTION_QUERY_ENGINE2_H_
...
template<typename T> using ClosestIntersectionDistanceFunc2 = std::function<double(const T &, const Vector2D &)>;

//! Box-item intersection test function.
template<typename T> using BoxIntersectionTestFunc2 = std::function<bool(const T &, const BoundingBox2D &)>;

//! Ray-item intersection test function.
template<typename T> using RayIntersectionTestFunc2 = std::function<bool(const T &, const Ray2D &)>;

//! Ray-item closest intersection evaluation function.
template<typename T> using GetRayIntersectionFunc2 = std::function<double(const T &, const Ray2D &)>;

//! Visitor function which is invoked for each intersecting item.
template<typename T> using IntersectionVisitorFunc2 = std::function<void(const T &)>;
...
#endif  // HINAPE_INTERSECTION_QUERY_ENGINE2_H_
