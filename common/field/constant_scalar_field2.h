#ifndef HINAPE_FLUID_ENGINE_CONSTANT_SCALAR_FIELD2_H_
#define HINAPE_FLUID_ENGINE_CONSTANT_SCALAR_FIELD2_H_
...
#endif  // HINAPE_FLUID_ENGINE_CONSTANT_SCALAR_FIELD2_H_
