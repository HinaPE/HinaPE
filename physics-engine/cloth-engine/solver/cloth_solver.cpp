...
auto HinaPE::ClothEngine::ClothSolver::Builder::build() const -> HinaPE::ClothEngine::ClothSolver { return ClothSolver(std::make_shared<ClothGeometryData>()); }
auto HinaPE::ClothEngine::ClothSolver::Builder::make_shared() const -> HinaPE::ClothEngine::ClothSolverPtr { return {new ClothSolver(std::make_shared<ClothGeometryData>()), [](ClothSolver *obj) { delete obj; }}; }
