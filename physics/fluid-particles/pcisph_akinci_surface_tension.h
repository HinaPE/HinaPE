#ifndef HINAPE_PCISPH_AKINCI_SURFACE_TENSION_H
#define HINAPE_PCISPH_AKINCI_SURFACE_TENSION_H
...
namespace HinaPE
{
    class PCISPHAkinciSurface: public Kasumi::INSPECTOR
    {
    protected:
    ...
    struct PCISPHAkinciSurface::Data : public Kasumi::ObjectParticles3D
    {
...
#endif //HINAPE_PCISPH_AKINCI_SURFACE_TENSION_H
