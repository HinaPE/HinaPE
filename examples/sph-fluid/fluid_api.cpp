...
void FluidAPI::add_collider(const std::shared_ptr<HinaPE::Collider3> &_collider_ptr) { collider_ptr_list.emplace_back(_collider_ptr); }
void FluidAPI::assign_particles_domain(const HinaPE::BoundingBox3D &_domain) { particles_domain = _domain; }
