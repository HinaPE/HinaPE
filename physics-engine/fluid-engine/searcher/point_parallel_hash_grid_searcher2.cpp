...
void PointParallelHashGridSearcher2::build(const ConstArrayAccessor1<Vector2D> &points)
{
    ...
    parallelSort(_sortedIndices.begin(), _sortedIndices.end(), [&tempKeys](size_t indexA, size_t indexB)
    {
...
{
    return std::shared_ptr<PointParallelHashGridSearcher2>(new PointParallelHashGridSearcher2(_resolution, _gridSpacing), [](PointParallelHashGridSearcher2 *obj)
    {
        delete obj;
    });
}
