...
#include "math_lib/bounding_box2.h"
...
void PointKdTreeSearcher2::forEachNearbyPoint(const Vector2D &origin, double radius, const ForEachNearbyPointFunc &callback) const
{
