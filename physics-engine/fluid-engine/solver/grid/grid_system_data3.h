...
#ifndef HINAPE_GRID_SYSTEM_DATA3_H
#define HINAPE_GRID_SYSTEM_DATA3_H
...
//!
    class GridSystemData3 : public HinaPE::Serializable {
    public:
        ...
        //!
        HinaPE::Size3 resolution() const;

        //! Return the grid spacing.
        HinaPE::Vector3D gridSpacing() const;

        //! Returns the origin of the grid.
        HinaPE::Vector3D origin() const;

        //! Returns the bounding box of the grid.
        HinaPE::BoundingBox3D boundingBox() const;
        ...
        size_t addVectorData(
                ...
                const HinaPE::Vector3D& initialVal = HinaPE::Vector3D());
        ...
        //!
        const HinaPE::FaceCenteredGrid3Ptr& velocity() const;
        ...
        const HinaPE::ScalarGrid3Ptr& scalarDataAt(size_t idx) const;

        //! Returns the non-advectable vector data at given index.
        const HinaPE::VectorGrid3Ptr& vectorDataAt(size_t idx) const;

        //! Returns the advectable scalar data at given index.
        const HinaPE::ScalarGrid3Ptr& advectableScalarDataAt(size_t idx) const;

        //! Returns the advectable vector data at given index.
        const HinaPE::VectorGrid3Ptr& advectableVectorDataAt(size_t idx) const;
    ...
    private:
        HinaPE::Size3 _resolution;
        HinaPE::Vector3D _gridSpacing;
        HinaPE::Vector3D _origin;

        HinaPE::FaceCenteredGrid3Ptr _velocity;
        size_t _velocityIdx;
        std::vector<HinaPE::ScalarGrid3Ptr> _scalarDataList;
        std::vector<HinaPE::VectorGrid3Ptr> _vectorDataList;
        std::vector<HinaPE::ScalarGrid3Ptr> _advectableScalarDataList;
        std::vector<HinaPE::VectorGrid3Ptr> _advectableVectorDataList;
    };
...
#endif //HINAPE_GRID_SYSTEM_DATA3_H
