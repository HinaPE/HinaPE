...
{
    return HinaPE::fbs::CreateScalarGridSerialized2(_fbb, type ? _fbb.CreateString(type) : 0, data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}
...
{
    return HinaPE::fbs::CreateVectorGridSerialized2(_fbb, type ? _fbb.CreateString(type) : 0, data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}
...
struct GridSystemData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<HinaPE::fbs::Size2>(verifier, VT_RESOLUTION) && VerifyField<HinaPE::fbs::Vector2D>(verifier, VT_GRIDSPACING) && VerifyField<HinaPE::fbs::Vector2D>(verifier, VT_ORIGIN) && VerifyField<uint64_t>(verifier, VT_VELOCITYIDX) &&
...
inline flatbuffers::Offset<GridSystemData2> CreateGridSystemData2(flatbuffers::FlatBufferBuilder &_fbb, const HinaPE::fbs::Size2 *resolution = 0, const HinaPE::fbs::Vector2D *gridSpacing = 0, const HinaPE::fbs::Vector2D *origin = 0, uint64_t velocityIdx = 0,
...
inline flatbuffers::Offset<GridSystemData2> CreateGridSystemData2Direct(flatbuffers::FlatBufferBuilder &_fbb, const HinaPE::fbs::Size2 *resolution = 0, const HinaPE::fbs::Vector2D *gridSpacing = 0, const HinaPE::fbs::Vector2D *origin = 0, uint64_t velocityIdx = 0,
...
{
    return HinaPE::fbs::CreateGridSystemData2(_fbb, resolution, gridSpacing, origin, velocityIdx, scalarData ? _fbb.CreateVector<flatbuffers::Offset<ScalarGridSerialized2>>(*scalarData) : 0,
...
inline const HinaPE::fbs::GridSystemData2 *GetGridSystemData2(const void *buf)
{
    return flatbuffers::GetRoot<HinaPE::fbs::GridSystemData2>(buf);
}

inline bool VerifyGridSystemData2Buffer(flatbuffers::Verifier &verifier)
{
    return verifier.VerifyBuffer<HinaPE::fbs::GridSystemData2>(nullptr);
}

inline void FinishGridSystemData2Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<HinaPE::fbs::GridSystemData2> root)
{
    fbb.Finish(root);
}
