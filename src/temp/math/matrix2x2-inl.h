...
{
    return (std::fabs(_elements[0] - m._elements[0]) < tol) && (std::fabs(_elements[1] - m._elements[1]) < tol) && (std::fabs(_elements[2] - m._elements[2]) < tol) && (std::fabs(_elements[3] - m._elements[3]) < tol);
}
...
{
    return Matrix(_elements[0] * m._elements[0] + _elements[1] * m._elements[2], _elements[0] * m._elements[1] + _elements[1] * m._elements[3], _elements[2] * m._elements[0] + _elements[3] * m._elements[2], _elements[2] * m._elements[1] + _elements[3] * m._elements[3]);
}
