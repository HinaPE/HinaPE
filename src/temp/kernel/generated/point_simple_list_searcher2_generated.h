...
inline flatbuffers::Offset<PointSimpleListSearcher2> CreatePointSimpleListSearcher2(flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::Vector<const jet::fbs::Vector2D *>> points = 0)
{
...
inline void FinishPointSimpleListSearcher2Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<jet::fbs::PointSimpleListSearcher2> root)
{
    fbb.Finish(root);
}
