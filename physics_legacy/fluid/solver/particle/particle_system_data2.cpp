...
void ParticleSystemData2::serializeParticleSystemData(flatbuffers::FlatBufferBuilder *builder, flatbuffers::Offset<fbs::ParticleSystemData2> *fbsParticleSystemData) const
{
    ...
    // Copy the searcher
    *fbsParticleSystemData = fbs::CreateParticleSystemData2(*builder, _radius, _mass, _positionIdx, _velocityIdx, _forceIdx, fbsScalarDataList, fbsVectorDataList, fbsNeighborSearcher, fbsNeighborLists);
}
