#ifndef HINAPE_PCISPH_AKINCI_H
#define HINAPE_PCISPH_AKINCI_H
...
namespace HinaPE
{
    class PCISPHAkinci: public Kasumi::INSPECTOR
    {
    protected:
    ...
    struct PCISPHAkinci::Data : public Kasumi::ObjectParticles3D
    {
