...
HinaPE::ClothEngine::PBDSolver::PBDSolver() = default;
...
void HinaPE::ClothEngine::PBDSolver::on_begin_advance_time_step(double time_interval_in_seconds)
{

}
void HinaPE::ClothEngine::PBDSolver::on_end_advance_time_step(double time_interval_in_seconds)
{

}

#include <iostream>
void HinaPE::ClothEngine::PBDSolver::print_hello()
{
    std::cout << "Hello Hina Cloth" << std::endl;
}
