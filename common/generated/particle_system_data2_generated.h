...
{
    return HinaPE::fbs::CreateScalarParticleData2(_fbb, data ? _fbb.CreateVector<double>(*data) : 0);
}
...
struct VectorParticleData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    const flatbuffers::Vector<const HinaPE::fbs::Vector2D *> *data() const
    {
        return GetPointer<const flatbuffers::Vector<const HinaPE::fbs::Vector2D *> *>(VT_DATA);
    }
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_DATA) && verifier.Verify(data()) && verifier.EndTable();
...
struct VectorParticleData2Builder
{
    flatbuffers::FlatBufferBuilder &fbb_;
    flatbuffers::uoffset_t start_;
    void add_data(flatbuffers::Offset<flatbuffers::Vector<const HinaPE::fbs::Vector2D *>> data)
    {
...
inline flatbuffers::Offset<VectorParticleData2> CreateVectorParticleData2(flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::Vector<const HinaPE::fbs::Vector2D *>> data = 0)
{
...
inline flatbuffers::Offset<VectorParticleData2> CreateVectorParticleData2Direct(flatbuffers::FlatBufferBuilder &_fbb, const std::vector<const HinaPE::fbs::Vector2D *> *data = nullptr)
{
    return HinaPE::fbs::CreateVectorParticleData2(_fbb, data ? _fbb.CreateVector<const HinaPE::fbs::Vector2D *>(*data) : 0);
}
...
{
    return HinaPE::fbs::CreatePointNeighborSearcherSerialized2(_fbb, type ? _fbb.CreateString(type) : 0, data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}
...
{
    return HinaPE::fbs::CreateParticleNeighborList2(_fbb, data ? _fbb.CreateVector<uint64_t>(*data) : 0);
}
...
{
    return HinaPE::fbs::CreateParticleSystemData2(_fbb, radius, mass, positionIdx, velocityIdx, forceIdx, scalarDataList ? _fbb.CreateVector<flatbuffers::Offset<ScalarParticleData2>>(*scalarDataList) : 0,
...
inline const HinaPE::fbs::ParticleSystemData2 *GetParticleSystemData2(const void *buf)
{
    return flatbuffers::GetRoot<HinaPE::fbs::ParticleSystemData2>(buf);
}

inline bool VerifyParticleSystemData2Buffer(flatbuffers::Verifier &verifier)
{
    return verifier.VerifyBuffer<HinaPE::fbs::ParticleSystemData2>(nullptr);
}

inline void FinishParticleSystemData2Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<HinaPE::fbs::ParticleSystemData2> root)
{
    fbb.Finish(root);
}
