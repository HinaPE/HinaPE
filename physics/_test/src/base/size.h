...
inline auto operator+(const Size3 &a) -> Size3 { return a; } // Positive sign operator.
inline auto operator-(const Size3 &a) -> Size3 { return {-a.x, -a.y, -a.z}; } // Negative sign operator.
inline auto operator+(const Size3 &a, size_t b) -> Size3 { return {a.x + b, a.y + b, a.z + b}; } // Computes (a.x, a.y, a.z) + (b, b, b).
inline auto operator+(size_t a, const Size3 &b) -> Size3 { return {a + b.x, a + b.y, a + b.z}; } // Computes (a, a, a) + (b.x, b.y, b.z).
inline auto operator+(const Size3 &a, const Size3 &b) -> Size3 { return {a.x + b.x, a.y + b.y, a.z + b.z}; } // Computes (a.x, a.y, a.z) + (b.x, b.y, b.z).
inline auto operator-(const Size3 &a, size_t b) -> Size3 { return {a.x - b, a.y - b, a.z - b}; } // Computes (a.x, a.y, a.z) - (b, b, b).
inline auto operator-(size_t a, const Size3 &b) -> Size3 { return {a - b.x, a - b.y, a - b.z}; } // Computes (a, a, a) - (b.x, b.y, b.z).
inline auto operator-(const Size3 &a, const Size3 &b) -> Size3 { return {a.x - b.x, a.y - b.y, a.z - b.z}; } // Computes (a.x, a.y, a.z) - (b.x, b.y, b.z).
inline auto operator*(const Size3 &a, size_t b) -> Size3 { return {a.x * b, a.y * b, a.z * b}; } // Computes (a.x, a.y, a.z) * (b, b, b).
