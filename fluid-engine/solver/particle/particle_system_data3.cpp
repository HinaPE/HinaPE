...
void ParticleSystemData3::serializeParticleSystemData(flatbuffers::FlatBufferBuilder *builder, flatbuffers::Offset<fbs::ParticleSystemData3> *fbsParticleSystemData) const
{
    ...
    // Copy the searcher
    *fbsParticleSystemData = fbs::CreateParticleSystemData3(*builder, _radius, _mass, _positionIdx, _velocityIdx, _forceIdx, fbsScalarDataList, fbsVectorDataList, fbsNeighborSearcher, fbsNeighborLists);
}
