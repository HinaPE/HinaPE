...
void Hina::GridFluidSolver::_update_emitter(float dt) { if (_emitter) _emitter->update(PhysicsAnimation::_opt._current_time, dt); }
void Hina::GridFluidSolver::_apply_boundary_condition()
{
//	auto vel = _grids->_velocity;
//	if (vel != nullptr && )
}
