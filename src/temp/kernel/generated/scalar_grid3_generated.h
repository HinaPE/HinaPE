...
CreateScalarGrid3(flatbuffers::FlatBufferBuilder &_fbb, const jet::fbs::Size3 *resolution = 0, const jet::fbs::Vector3D *gridSpacing = 0, const jet::fbs::Vector3D *origin = 0, flatbuffers::Offset<flatbuffers::Vector<double>> data = 0)
{
...
inline flatbuffers::Offset<ScalarGrid3> CreateScalarGrid3Direct(flatbuffers::FlatBufferBuilder &_fbb, const jet::fbs::Size3 *resolution = 0, const jet::fbs::Vector3D *gridSpacing = 0, const jet::fbs::Vector3D *origin = 0, const std::vector<double> *data = nullptr)
{
...
inline void FinishScalarGrid3Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<jet::fbs::ScalarGrid3> root)
{
    fbb.Finish(root);
}
