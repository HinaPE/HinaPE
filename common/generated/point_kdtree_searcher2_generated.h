...
CreatePointKdTreeSearcher2(flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::Vector<const HinaPE::FluidEngine::fbs::Vector2D *>> points = 0, flatbuffers::Offset<flatbuffers::Vector<const PointKdTreeSearcherNode2 *>> nodes = 0)
{
...
inline flatbuffers::Offset<PointKdTreeSearcher2> CreatePointKdTreeSearcher2Direct(flatbuffers::FlatBufferBuilder &_fbb, const std::vector<const HinaPE::FluidEngine::fbs::Vector2D *> *points = nullptr, const std::vector<const PointKdTreeSearcherNode2 *> *nodes = nullptr)
{
    return HinaPE::FluidEngine::fbs::CreatePointKdTreeSearcher2(_fbb, points ? _fbb.CreateVector<const HinaPE::FluidEngine::fbs::Vector2D *>(*points) : 0, nodes ? _fbb.CreateVector<const PointKdTreeSearcherNode2 *>(*nodes) : 0);
}

inline const HinaPE::FluidEngine::fbs::PointKdTreeSearcher2 *GetPointKdTreeSearcher2(const void *buf)
{
    return flatbuffers::GetRoot<HinaPE::FluidEngine::fbs::PointKdTreeSearcher2>(buf);
}

inline bool VerifyPointKdTreeSearcher2Buffer(flatbuffers::Verifier &verifier)
{
    return verifier.VerifyBuffer<HinaPE::FluidEngine::fbs::PointKdTreeSearcher2>(nullptr);
}

inline void FinishPointKdTreeSearcher2Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<HinaPE::FluidEngine::fbs::PointKdTreeSearcher2> root)
{
    fbb.Finish(root);
}
