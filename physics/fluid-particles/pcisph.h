#ifndef HINAPE_PCISPH_H
#define HINAPE_PCISPH_H
...
namespace HinaPE
{
    class PCISPH: public Kasumi::INSPECTOR
    {
    protected:
    ...
    struct PCISPH::Data : public Kasumi::ObjectParticles3D
    {
