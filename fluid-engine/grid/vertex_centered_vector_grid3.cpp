...
VertexCenteredVectorGrid3::VertexCenteredVectorGrid3(size_t resolutionX, size_t resolutionY, size_t resolutionZ, double gridSpacingX, double gridSpacingY, double gridSpacingZ, double originX, double originY, double originZ, double initialValueU, double initialValueV,
...
void VertexCenteredVectorGrid3::fill(const Vector3D &value, ExecutionPolicy policy)
{
    ...
    parallelFor(kZeroSize, size.x, kZeroSize, size.y, kZeroSize, size.z, [value, &acc](size_t i, size_t j, size_t k) { acc(i, j, k) = value; }, policy);
}
...
void VertexCenteredVectorGrid3::fill(const std::function<Vector3D(const Vector3D &)> &func, ExecutionPolicy policy)
{
    ...
    parallelFor(kZeroSize, size.x, kZeroSize, size.y, kZeroSize, size.z, [&func, &acc, &pos](size_t i, size_t j, size_t k)
    {
