...
const HinaPE::Vector3D& GridFluidSolver3::gravity() const { return _gravity; }
...
HinaPE::Size3 GridFluidSolver3::resolution() const { return _grids->resolution(); }

HinaPE::Vector3D GridFluidSolver3::gridSpacing() const { return _grids->gridSpacing(); }

HinaPE::Vector3D GridFluidSolver3::gridOrigin() const { return _grids->origin(); }

const HinaPE::FaceCenteredGrid3Ptr& GridFluidSolver3::velocity() const {
    return _grids->velocity();
}

const HinaPE::Collider3Ptr& GridFluidSolver3::collider() const { return _collider; }
...
HinaPE::ScalarField3Ptr GridFluidSolver3::fluidSdf() const {
...
HinaPE::ScalarField3Ptr GridFluidSolver3::colliderSdf() const {
    return _boundaryConditionSolver->colliderSdf();
}

HinaPE::VectorField3Ptr GridFluidSolver3::colliderVelocityField() const {
