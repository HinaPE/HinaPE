...
const std::vector<std::vector<size_t>> &PointHashGridSearcher2::buckets() const
{
    return _buckets;
}
...
{
    return std::shared_ptr<PointHashGridSearcher2>(new PointHashGridSearcher2(_resolution, _gridSpacing), [](PointHashGridSearcher2 *obj)
    {
        delete obj;
    });
}
