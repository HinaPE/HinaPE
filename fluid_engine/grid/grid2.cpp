...
{
    return _resolution.x == other._resolution.x && _resolution.y == other._resolution.y && similar(_gridSpacing.x, other._gridSpacing.x) && similar(_gridSpacing.y, other._gridSpacing.y) && similar(_origin.x, other._origin.x) && similar(_origin.y, other._origin.y);
}
