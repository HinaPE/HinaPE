...
//{
//public:
//	inline auto to_local(const mBBox3 &bbox_in_world) const -> mBBox3
//	{
//		mBBox3 bbox_in_local;
//		for (int i = 0; i < 8; ++i)
//		{
...
//	}
//	inline auto to_world(const mBBox3 &bbox_in_local) const -> mBBox3
//	{
//		mBBox3 bbox_in_world;
//		for (int i = 0; i < 8; ++i)
//		{
