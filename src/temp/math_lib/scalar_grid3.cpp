...
#include "kernel/generated/scalar_grid3_generated.h"
...
void ScalarGrid3::resize(size_t resolutionX, size_t resolutionY, size_t resolutionZ, double gridSpacingX, double gridSpacingY, double gridSpacingZ, double originX, double originY, double originZ, double initialValue)
{
...
{
    parallelFor(kZeroSize, _data.width(), kZeroSize, _data.height(), kZeroSize, _data.depth(), [this, value](size_t i, size_t j, size_t k) { _data(i, j, k) = value; }, policy);
}
...
void ScalarGrid3::fill(const std::function<double(const Vector3D &)> &func, ExecutionPolicy policy)
{
    ...
    parallelFor(kZeroSize, _data.width(), kZeroSize, _data.height(), kZeroSize, _data.depth(), [this, &func, &pos](size_t i, size_t j, size_t k)
    {
