...
void Hina::Collider::update(Hina::real current_time, Hina::real time_interval)
{
...
void Hina::Collider::resolve_collision(Hina::real radius, Hina::real restitution, Hina::mVector3 &position, Hina::mVector3 &velocity) const
{
...
auto Hina::Collider::get_closest_point(const Hina::Surface3Ptr &surface, const Hina::mVector3 &query_point) const -> Hina::Collider::ColliderQueryResult
{
...
auto Hina::Collider::is_penetrating(const Hina::Collider::ColliderQueryResult &result, const Hina::mVector3 &position, Hina::real radius) const -> bool
{
