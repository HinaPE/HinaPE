#ifndef HINAPE_VECTOR_EXPRESSION_H_
#define HINAPE_VECTOR_EXPRESSION_H_
...
template<typename T, typename E, typename U> using VectorTypeCast = VectorUnaryOp<T, E, TypeCast<U, T>>;
...
template<typename T, typename E1, typename E2> using VectorAdd = VectorBinaryOp<T, E1, E2, std::plus<T>>;

//! Vector-scalar addition expression.
template<typename T, typename E> using VectorScalarAdd = VectorScalarBinaryOp<T, E, std::plus<T>>;

//! Vector-vector addition expression.
template<typename T, typename E1, typename E2> using VectorSub = VectorBinaryOp<T, E1, E2, std::minus<T>>;

//! Vector-scalar subtraction expression.
template<typename T, typename E> using VectorScalarSub = VectorScalarBinaryOp<T, E, std::minus<T>>;

//! Scalar-vector subtraction expression.
template<typename T, typename E> using VectorScalarRSub = VectorScalarBinaryOp<T, E, RMinus<T>>;

//! Element-wise vector-vector multiplication expression.
template<typename T, typename E1, typename E2> using VectorMul = VectorBinaryOp<T, E1, E2, std::multiplies<T>>;

//! Vector-scalar multiplication expression.
template<typename T, typename E> using VectorScalarMul = VectorScalarBinaryOp<T, E, std::multiplies<T>>;

//! Element-wise vector-vector division expression.
template<typename T, typename E1, typename E2> using VectorDiv = VectorBinaryOp<T, E1, E2, std::divides<T>>;

//! Vector-scalar division expression.
template<typename T, typename E> using VectorScalarDiv = VectorScalarBinaryOp<T, E, std::divides<T>>;

//! Scalar-vector division expression.
template<typename T, typename E> using VectorScalarRDiv = VectorScalarBinaryOp<T, E, RDivides<T>>;
...
#endif  // HINAPE_VECTOR_EXPRESSION_H_
