...
#include "point_generator/triangle_point_generator.h"
#include "math/matrix2x2.h"
#include "searcher/point_hash_grid_searcher2.h"
#include "geometry/surface_to_implicit2.h"
...
VolumeParticleEmitter2::VolumeParticleEmitter2(const ImplicitSurface2Ptr &implicitSurface, const BoundingBox2D &maxRegion, double spacing, const Vector2D &initialVel, const Vector2D &linearVel, double angularVel, size_t maxNumberOfParticles, double jitter,
...
{
    return std::shared_ptr<VolumeParticleEmitter2>(new VolumeParticleEmitter2(_implicitSurface, _bounds, _spacing, _initialVel, _linearVel, _angularVel, _maxNumberOfParticles, _jitter, _isOneShot, _allowOverlapping), [](VolumeParticleEmitter2 *obj) { delete obj; });
}
