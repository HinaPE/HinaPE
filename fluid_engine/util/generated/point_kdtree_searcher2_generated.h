...
CreatePointKdTreeSearcher2(flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::Vector<const jet::fbs::Vector2D *>> points = 0, flatbuffers::Offset<flatbuffers::Vector<const PointKdTreeSearcherNode2 *>> nodes = 0)
{
...
inline flatbuffers::Offset<PointKdTreeSearcher2> CreatePointKdTreeSearcher2Direct(flatbuffers::FlatBufferBuilder &_fbb, const std::vector<const jet::fbs::Vector2D *> *points = nullptr, const std::vector<const PointKdTreeSearcherNode2 *> *nodes = nullptr)
{
...
inline void FinishPointKdTreeSearcher2Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<jet::fbs::PointKdTreeSearcher2> root)
{
    fbb.Finish(root);
}
