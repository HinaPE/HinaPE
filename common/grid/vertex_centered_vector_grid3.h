#ifndef HINAPE_VERTEX_CENTERED_VECTOR_GRID3_H_
#define HINAPE_VERTEX_CENTERED_VECTOR_GRID3_H_
...
public:
    ...
    //! initial value.
    VertexCenteredVectorGrid3(size_t resolutionX, size_t resolutionY, size_t resolutionZ, double gridSpacingX = 1.0, double gridSpacingY = 1.0, double gridSpacingZ = 1.0, double originX = 0.0, double originY = 0.0, double originZ = 0.0, double initialValueU = 0.0,
...
#endif  // HINAPE_VERTEX_CENTERED_VECTOR_GRID3_H_
